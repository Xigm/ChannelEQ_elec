function [tx,bits_tx,pilotosReturn] = OFDM_TX_DVT2(NFFT,NCP,useCarrier,NUM_SYMB,SEED,CONSTEL,SNR,verbose)
...
%     pilotos = (pilotos-0.5)*2;
    ...
    pilotos = (pilotos-0.5)*2;
    pilotosReturn = pilotos(1:12:end);
    ...
    ofdm_freq_rx(ceil((NFFT-useCarrier)/2)+(pilotsLoc),:) = (4/3)*reshape(pilotos(1:12:end),length(pilotsLoc),NUM_SYMB);
