function [muestras, hest, v, pilotosReturn,ofdm_freq_rx_eq] = GoldenChannelEstim2(mode,CONSTEL,SNR,noiseON,canalON,NUM_SYMB,SEED)
...
%     NUM_SYMB = 10;       % Número de símbols a transmitir
    ...
    %% Transmisión
    [tx,bits_tx,pilotosReturn] = OFDM_TX_DVT2(NFFT,NCP,useCarrier,NUM_SYMB,SEED,CONSTEL,SNR,0);
...
%    canal = ones(1,useCarrier);
    ...
    % Cálculo de la hest
    hest = ofdm_freq_rx_pilots./((4/3)*reshape(pilotos(1:12:end),length(pilotsLoc),NUM_SYMB));
