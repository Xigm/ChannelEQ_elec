...
\definecolor{matbg}{RGB}{250, 245, 172}

\newmintedfile[inputmintedMat]{Matlab}{linenos=true,bgcolor = matbg, breaklines = true, frame = single}
% \newmintedfile[inputmintedPy]{python}{linenos=true, bgcolor = colorPy, breaklines = true,frame = single}
% \newmintedfile[inputmintedPy]{python}{linenos=true, bgcolor = negro, breaklines = true,frame = single,rulecolor = null,texcomments = true}
